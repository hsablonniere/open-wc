...
### compatibility
The compatibility option makes your code compatible with older browsers. For testing it's best to leave this at 'none' for no modifications, or 'all' for full compatibility.
